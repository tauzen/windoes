        ...
        <div className={`dialog-overlay run-dialog${isOpen ? ' active' : ''}`} id="runDialog">
            <div className="dialog-box" style={{ minWidth: '380px' }}>
                <div className="dialog-titlebar">
                    <span>Run</span>
                    <button className="ctrl-btn" id="runCloseBtn" aria-label="Close" onClick={closeDialog}>×</button>
                </div>
                ...
                <div className="dialog-buttons">
                    <button className="dialog-btn" id="runOkBtn" onClick={runCommand}>OK</button>
                    <button className="dialog-btn" id="runCancelBtn" onClick={closeDialog}>Cancel</button>
