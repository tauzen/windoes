const config = {
  ...
  randomErrors: [
    {
      title: 'Explorer',
      text: 'This program has performed an illegal operation and will be shut down. If the problem persists, contact the program vendor.',
      icon: 'error',
    },
    {
      title: 'Windoes',
      text: 'Not enough memory to complete this operation. Close some programs and try again.',
      icon: 'warning',
    },
    {
      title: 'RUNDLL32',
      text: 'Error in MMSYSTEM.DLL. Missing entry: SndPlaySoundA',
      icon: 'error',
    },
    {
      title: 'DrWatson Postmortem Debugger',
      text: 'An application error has occurred and an application error log is being generated.\n\nException: access violation (0xc0000005), Address: 0x77f9f3d1',
      icon: 'error',
    },
    {
      title: 'Windoes Update',
      text: 'Windoes Update has encountered an error and needs to close. We are sorry for the inconvenience. Error code: 0x80072EFD',
      icon: 'warning',
    },
    {
      title: 'System Resources',
      text: 'Warning: Your system is running low on system resources. To correct this, close some windoes.',
      icon: 'warning',
    },
    {
      title: 'Internet Explorer',
      text: 'Internet Explorer has encountered a problem and needs to close. We are sorry for the inconvenience.',
      icon: 'error',
    },
    {
      title: 'Disk Cleanup',
      text: 'The disk cleanup utility could not free any space. Your hard drive may be full.',
      icon: 'info',
    },
  ],
  experimentApps: [
