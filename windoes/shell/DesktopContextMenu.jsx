...
export default function DesktopContextMenu() {
    ...
    return (
        <>
            ...
            >
                <div className="context-menu-item" data-action="arrange" onClick={() => onMenuAction('arrange')}>Arrange Icons</div>
                <div className="context-menu-item" data-action="lineup">Line Up Icons</div>
                <div className="context-menu-sep"></div>
                <div className="context-menu-item" data-action="refresh" onClick={() => onMenuAction('refresh')}>Refresh</div>
                <div className="context-menu-sep"></div>
                ...
                <div className="context-menu-sep"></div>
                <div className="context-menu-item" data-action="new" onClick={() => onMenuAction('new')}>New         ▶</div>
                <div className="context-menu-sep"></div>
                <div className="context-menu-item" data-action="properties" onClick={() => onMenuAction('properties')}>Properties</div>
            </div>
            <div
